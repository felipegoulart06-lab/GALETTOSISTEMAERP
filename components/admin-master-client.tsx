...
> = {
  ...
  lives: {
    ...
    fields: [
      ...
      { name: "provider", label: "Provedor da live", type: "select", section: "Programação", options: ["internal", "tiktok"] },
      ...
      { name: "transmissionLink", label: "Link da transmissão (MP4/HLS interno ou URL oficial do TikTok)", type: "text", section: "Programação" },
  ...
  switch (sectionKey) {
    ...
    case "lives":
      return {
        ...
        provider: String(formState.provider ?? existing?.provider ?? "internal") === "tiktok" ? "tiktok" : "internal",
